...
const footerLinks = {
  ...
  learn: [
    { label: 'Docs', href: 'https://deessejs.com/docs' },
  ...
  usecases: [
    { label: 'Autonomous Agents', href: 'https://deessejs.com/solution/autonomous-agents' },
    { label: 'Workflows', href: 'https://deessejs.com/solution/workflows' },
    { label: 'Github Bot', href: 'https://deessejs.com/solution/github-bot' },
    { label: 'Content Creation', href: 'https://deessejs.com/solution/content-creation' },
  ],
  company: [
    { label: 'About', href: 'https://deessejs.com/about' },
    { label: 'Help', href: 'https://deessejs.com/help' },
    { label: 'Legal', href: 'https://deessejs.com/legal' },
    { label: 'Privacy Policy', href: 'https://deessejs.com/privacy-policy' },
  ],
  community: [
    { label: 'Open Source Program', href: 'https://deessejs.com/oss-program' },
    { label: 'Students', href: 'https://deessejs.com/students' },
